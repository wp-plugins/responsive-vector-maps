...
function rvm_map_shortcode( $attr ) {    // $attr manages the shortcode parameter - [rvm_map mapid="xxxx" width="xxxx"]
    ...
    if ( isset( $attr[ 'mapid' ] ) && is_numeric( $attr[ 'mapid' ] ) ) { // Check if mapid attr exists and if is numeric
        ...
        if ( !empty( $postid ) ) {
            ...
            $rvm_mbe_map_marker_bg_color = !empty ( $rvm_mbe_map_marker_bg_color ) ? $rvm_mbe_map_marker_bg_color : RVM_MARKER_BG_COLOR ;
            $rvm_mbe_map_marker_border_color = !empty ( $rvm_mbe_map_marker_border_color ) ? $rvm_mbe_map_marker_border_color : RVM_MARKER_BORDER_COLOR ;
            ...
            */
            ...
            && is_array( $marker_array_unserialized['rvm_marker_long_array'] ) ) {
                ...
                $rvm_is_dim_value_more_then_two = '' ;    
                ...
                for( $i=0; $i < $rvm_marker_array_count; $i++ ) {
                    ...
                    if( !empty( $marker_array_unserialized['rvm_marker_popup_array'][ $i ] ) ) {
                        ...
                        $output .= '"' .  force_balance_tags( $marker_array_unserialized['rvm_marker_popup_array'][ $i ] ) . '"' ;//decode html entities into html tags
            ...
            */                 
            ...
            foreach ( $array_regions as $region ) {
                ...
                if( is_array( $regionsparams_array ) && !empty( $regionsparams_array ) ) {                        
                    ...
                    if( !empty( $regionsparams_array[ 'field_region_popup' ] ) ) {                       
            ...
            */    
            ...
            $output .= ', onRegionOver : function(event, code, region, label){' ;            
