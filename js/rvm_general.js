	...
	$(function() {	
		...
		$( '#rvm_mbe_select_map' ).change( function() {
			...
			if( $( '#rvm_mbe_select_map' ).val() === 'rvm_custom_map' ) {
				...
				rvm_custom_map_filename = rvm_custom_map_filename + '<h3 class="rvm_custom_map_filename_title">Paste here complete map name ( i.e.: italy_merc_en.zip or  italy_merc_en ) loaded via Media Uploader</h3>';
