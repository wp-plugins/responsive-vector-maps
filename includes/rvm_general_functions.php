...
{
            $custom_map_name_array = explode( '_', $map_name );
...
function rvm_retrieve_custom_map_raw_name( $filename, $map_ext )
{
            $custom_map_raw_name = substr( $filename, 0, -( strlen( $map_ext ) ) );
            return $custom_map_raw_name;
}

//Get filename extension: i.e. .zip
function rvm_retrieve_custom_map_ext( $filename, $map_ext )
{
            $custom_map_ext = substr( $filename, -( strlen( $map_ext ) ) );
            return $custom_map_ext;
}
