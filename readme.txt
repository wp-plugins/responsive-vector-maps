...
* Many maps available: France ( regions ), Germany, Italy, Netherlands, Norway, Poland, Portugal, Spain, Sweden, Switzerland, United Kingdom, Europe, USA, Belgium and whole World ( with clickable countries ).
* Mouseover tooltip effect
* Regions/countries: customise background colours, links and html popup ( tooltip )
