...
* Regions/countries: customise background colours and link each
* Markers: add your linkable markers on the map
...
6. Region background colour and links
7. Markers background colour, border colour, links, dimension and popup message
