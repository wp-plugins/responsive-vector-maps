    ...
    if( isset( $_POST[ 'rvm_mbe_select_map' ] ) && $_POST[ 'rvm_mbe_select_map' ] != 'select_country'  ) {
        ...
        foreach( $array_fields as $field ) {
            ...
            if( isset( $_POST[ $field[ 1 ] ] ) ) {
                    ...
                    $rvm_region_array = $_POST[ $field[ 1 ] ] ; //change html into entities and close unclosed tags
        ...
        if( isset( $_POST[ 'rvm_marker_name' ] ) ) {
            ...
            if( !empty( $_POST[ 'rvm_marker_popup' ] ) ) {              
                ...
                $rvm_marker_label_array = $_POST[ 'rvm_marker_popup' ] ; //change html into entities and close unclosed tags
